...
/**
 *  \file       core/modules/voyagebuilder/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_voyage
 */
class pdf_standard_voyage extends ModelePDFVoyage
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_VOYAGE_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->voyagebuilder->dir_output.'/voyage') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->voyagebuilder->dir_output.'/voyage';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->voyagebuilder->dir_output.'/voyage/'.$objectref;
