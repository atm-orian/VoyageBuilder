...
/**
 * \file    core/triggers/interface_99_modVoyageBuilder_VoyageBuilderTriggers.class.php
 ...
 *      - interface_99_modVoyageBuilder_MyTrigger.class.php
...
/**
 *  Class of triggers for VoyageBuilder module
 */
class InterfaceVoyageBuilderTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "VoyageBuilder triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'voyagebuilder@voyagebuilder';
	}
