...
/**
 * \file    test/phpunit/VoyageBuilderFunctionalTest.php
...
/**
 * Class VoyageBuilderFunctionalTest
 *
 ...
 *
 * @package Testvoyagebuilder
 */
class VoyageBuilderFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modVoyageBuilder')->click();
		} else {
			// Disable the module
			$this->byHref('modVoyageBuilder')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/voyagebuilder/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('voyagebuilder/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/voyagebuilder/admin/about.php');
		$this->authenticate();
		return $this->assertContains('voyagebuilder/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('voyagebuilderwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modVoyageBuilder_VoyageBuilderTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modVoyageBuilder_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
